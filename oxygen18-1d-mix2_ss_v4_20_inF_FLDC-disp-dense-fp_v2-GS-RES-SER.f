      ...
      double precision dsw(3,nry), drpmx(6,nry), drpmn(6,nry)
...
!       
     ...
     $                             status='replace')
      ...
      if (i5 == 1) then
      open(60, file = 'C:/Users/YK/Desktop/Isotope/rainwater-dy.txt'
     $   ,status = 'old')
      read(60,*) dsw
      ! close(60)
      else if (i5 /= 1) then
     ...
     $   ,status = 'old')
      ...
      dsw(2,:) = dsw(2,:) - (0.69d0*temp(:) - 13.6d0)
      dsw(3,:) = dsw(3,:) - (0.299d0*temp(:) - 12.4d0)
      
      if (i5 == n5) close(60)
      
      write(*,*) dsw(1,1),dsw(2,1),dsw(3,1)
