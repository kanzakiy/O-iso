...
axes[0].fill_between(dsw_d18_ss[:,0],np.amin(dsw_d18_ss[:,1:],axis=1),np.amax(dsw_d18_ss[:,1:],axis=1)
    ,hatch ='xxxxxx',linestyle = 'solid',edgecolor = 'k',facecolor='None',label = 'Steady state')
...
# axes[1].fill_between(dsw_capd17_ss[:,0],np.amin(dsw_capd17_ss[:,1:],axis=1),np.amax(dsw_capd17_ss[:,1:],axis=1)
    # ,hatch ='xxxxxx',linestyle = 'solid',edgecolor = 'k',facecolor='None')
# axes[1].fill_between(dsw_capd17_min[:,0],np.amin(dsw_capd17_max[:,1:],axis=1),np.amax(dsw_capd17_min[:,1:],axis=1)
...
fig.subplots_adjust(left=0.2,right= 0.95 ,bottom=0.15,top = 0.95,wspace=0.2,hspace=0.1)
