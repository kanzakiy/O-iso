...
!---------------------------------------------------      
      ...
      open (12, file ='C:/Users/User/Desktop/Isotope/'//
     $ 'o_iso_cw_flux.csv',status = 'replace')
      open (13, file ='C:/Users/User/Desktop/Isotope/'//
     $ 'o_iso_cw_cdf.csv',status = 'replace')
      
      open (90, file ='C:/Users/User/Desktop/Isotope/'//
     $ 'o_iso_cw+ht_Wallmann.dat',status = 'replace')
      open (92, file ='C:/Users/User/Desktop/Isotope/'//
     ...
     $   '/o_iso_cw_d18O.csv',status = 'replace')
